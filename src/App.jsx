...
import QualityAssuranceComponent from "./scenes/Inventory/QualityAssuranceComponent";

import Store from "./scenes/Store/store";

const Settings = React.lazy(() => import("./scenes/user/Settings"));
const Cart = React.lazy(() => import("./scenes/Admin/Cart"));

// Wrap components with React.lazy
const Dashboard = React.lazy(() => import("./scenes/dashboard"));
const Users = React.lazy(() => import("./scenes/Registration/users"));
...
const ProductsLog = React.lazy(() => import("./scenes/Registration/adminApproval"));
      ...
      case "Quality Assurance":
        return (
          <Routes>
            ...
            <Route
              path="/qualityAssurances"
              element={<QualityAssuranceComponent />}
            />
          </Routes>
        );
      case "Finance":
